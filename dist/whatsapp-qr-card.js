...
let WhatsAppQrCard = class WhatsAppQrCard extends i {
    constructor() {
        super(...arguments);
        this._busy = false;
    }
    ...
    render() {
        ...
        const phone = statusEntity?.attributes?.phone;
        return b `
      <ha-card header="WhatsApp Bridge">
        ...
        ${stateValue === "qr" && imageEntity?.attributes?.entity_picture
            ? b `<img class="qr" alt="WhatsApp QR" src=${imageEntity.attributes.entity_picture} />`
            : A}
        ${stateValue === "ready"
            ? b `<div class="meta">Linked to ${phone || "phone"}</div>`
            : A}
...
__decorate([
    n({ attribute: false })
], WhatsAppQrCard.prototype, "hass", void 0);
__decorate([
    r()
], WhatsAppQrCard.prototype, "_config", void 0);
__decorate([
    r()
], WhatsAppQrCard.prototype, "_busy", void 0);
WhatsAppQrCard = __decorate([
    t("whatsapp-qr-card")
], WhatsAppQrCard);
...
export { WhatsAppQrCard };
//# sourceMappingURL=whatsapp-qr-card.js.map
